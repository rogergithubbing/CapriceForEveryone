...
// French CPC keyboard
static tUShort cpc_kbd_fr[CPC_KEY_NONE] =
{
  0x40 | MOD_CPC_SHIFT,   // CPC_KEY_0
  0x80 | MOD_CPC_SHIFT,   // CPC_KEY_1
  0x81 | MOD_CPC_SHIFT,   // CPC_KEY_2
  0x71 | MOD_CPC_SHIFT,   // CPC_KEY_3
  0x70 | MOD_CPC_SHIFT,   // CPC_KEY_4
  0x61 | MOD_CPC_SHIFT,   // CPC_KEY_5
  0x60 | MOD_CPC_SHIFT,   // CPC_KEY_6
  0x51 | MOD_CPC_SHIFT,   // CPC_KEY_7
  0x50 | MOD_CPC_SHIFT,   // CPC_KEY_8
  0x41 | MOD_CPC_SHIFT,   // CPC_KEY_9
  0x83 | MOD_CPC_SHIFT,   // CPC_KEY_A
  ...
  0x87 | MOD_CPC_SHIFT,   // CPC_KEY_W
  0x77 | MOD_CPC_SHIFT,   // CPC_KEY_X
  0x53 | MOD_CPC_SHIFT,   // CPC_KEY_Y
  0x73 | MOD_CPC_SHIFT,   // CPC_KEY_Z
  0x83,                   // CPC_KEY_a
  0x66,                   // CPC_KEY_b
  0x76,                   // CPC_KEY_c
  0x75,                   // CPC_KEY_d
  ...
  0x53,                   // CPC_KEY_y
  0x73,                   // CPC_KEY_z
  0x80,                   // CPC_KEY_AMPERSAND
  0x21,                   // CPC_KEY_ASTERISK
  0x26 | MOD_CPC_SHIFT,   // CPC_KEY_AT
  CPC_KEY_INVALID,        // CPC_KEY_BACKQUOTE
  0x26 | MOD_CPC_CTRL,    // CPC_KEY_BACKSLASH
  ...
  0x71,                   // CPC_KEY_DBLQUOTE
  0x97,                   // CPC_KEY_DEL
  0x26,                   // CPC_KEY_DOLLAR
  0x06,                   // CPC_KEY_ENTER
  0x36,                   // CPC_KEY_EQUAL
  0x82,                   // CPC_KEY_ESC
  0x50,                   // CPC_KEY_EXCLAMATN
  0x17,                   // CPC_KEY_F0
  0x15,                   // CPC_KEY_F1
  0x16,                   // CPC_KEY_F2
  0x05,                   // CPC_KEY_F3
  ...
  0x23 | MOD_CPC_SHIFT,   // CPC_KEY_GREATER
  0x23,                   // CPC_KEY_HASH
  0x31 | MOD_CPC_SHIFT,   // CPC_KEY_LBRACKET
  CPC_KEY_INVALID,        // CPC_KEY_LCBRACE
  0x61,                   // CPC_KEY_LEFTPAREN
  0x21 | MOD_CPC_SHIFT,   // CPC_KEY_LESS
  0x25 | MOD_CPC_SHIFT,   // CPC_KEY_LSHIFT
  0x30,                   // CPC_KEY_MINUS
  0x34 | MOD_CPC_SHIFT,   // CPC_KEY_PERCENT
  0x47 | MOD_CPC_SHIFT,   // CPC_KEY_PERIOD
  0x32 | MOD_CPC_SHIFT,   // CPC_KEY_PIPE
  0x36 | MOD_CPC_SHIFT,   // CPC_KEY_PLUS
  CPC_KEY_INVALID,        // CPC_KEY_POUND
  0x32,                   // CPC_KEY_POWER
  0x46 | MOD_CPC_SHIFT,   // CPC_KEY_QUESTION
  0x70,                   // CPC_KEY_QUOTE
  0x60,                   // CPC_KEY_RBRACKET
  CPC_KEY_INVALID,        // CPC_KEY_RCBRACE
  0x22,                   // CPC_KEY_RETURN
  0x31,                   // CPC_KEY_RIGHTPAREN
  0x25 | MOD_CPC_SHIFT,   // CPC_KEY_RSHIFT
  0x47,                   // CPC_KEY_SEMICOLON
  0x37 | MOD_CPC_SHIFT,   // CPC_KEY_SLASH
  0x57,                   // CPC_KEY_SPACE
  0x84,                   // CPC_KEY_TAB
  0x30 | MOD_CPC_SHIFT,   // CPC_KEY_UNDERSCORE
  0x90,                   // CPC_KEY_J0_UP
  ...
  CPC_KEY_INVALID,        // CPC_KEY_ES_NTILDE
  CPC_KEY_INVALID,        // CPC_KEY_ES_nTILDE
  CPC_KEY_INVALID,        // CPC_KEY_ES_PESETA
  0x81,                   // CPC_KEY_FR_eACUTE
  0x51,                   // CPC_KEY_FR_eGRAVE
  0x41,                   // CPC_KEY_FR_cCEDIL
  0x40,                   // CPC_KEY_FR_aGRAVE
  0x34,                   // CPC_KEY_FR_uGRAVE
};
