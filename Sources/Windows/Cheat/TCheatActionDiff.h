...
#ifndef TCheatActionDiffH
#define TCheatActionDiffH

#include "TCheatAction.h"


class TCheatActionDiff : public TCheatAction
{
private:
  //
  // Members
...
public:
  ...
  // Public API
  //
  __fastcall TCheatActionDiff(AnsiString Command);
  virtual __fastcall ~TCheatActionDiff();
