...
__fastcall TCheatActionDiff::TCheatActionDiff(AnsiString Command) : TCheatAction()
//
// Constructor
//
{
...
__fastcall TCheatActionDiff::~TCheatActionDiff(void)
//
// Destructor
//
{
...
void __fastcall TCheatActionDiff::Execute(tNativeCPC* NativeCPC)
{
...
AnsiString __fastcall TCheatActionDiff::NextAction(void)
{
