...
__fastcall TCheatActionDriveA::TCheatActionDriveA(AnsiString Command) : TCheatAction()
//
// Constructor
//
{
...
__fastcall TCheatActionDriveA::~TCheatActionDriveA(void)
//
// Destructor
//
{
...
void __fastcall TCheatActionDriveA::Execute(tNativeCPC* NativeCPC)
{
  // Load Drive A
  FormMain->EjectDriveA();
  FormMain->LoadDriveA(mFilename, false);
