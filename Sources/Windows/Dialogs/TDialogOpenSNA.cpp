...
__fastcall TDialogOpenSNA::TDialogOpenSNA(TDrawingContext* DrawingContextP) : TDialogForm()
//
// Constructor
//
{
...
TColor InactiveColor = (TColor)0x00000000; // ABGR
  ...
  LabelTitle->Text = "Select snapshot file";
  ...
  ButtonSNA = new TDialogButton(DrawingContextP);
  ButtonSNA->ActiveColor = ActiveColor;
  ButtonSNA->InactiveColor = InactiveColor;
  ButtonSNA->Left = 0.25f;
  ButtonSNA->Right = 0.35f;
  ButtonSNA->Top = 0.08f;
  ButtonSNA->Bottom = 0.13f;
  ButtonSNA->Text = "SNA";
  ButtonSNA->Type = ToggleButton;
  ButtonSNA->Activated = true;
  ButtonSNA->OnPressed = OnExtensionsPressed;
...
//---------------------------------------------------------------------------
 ...
 __fastcall TDialogOpenSNA::~TDialogOpenSNA()
//
// Destructor
//
{
...
bool __fastcall TDialogOpenSNA::OnKeyDown(WORD &Key)
{
bool treated = true;
...
void __fastcall TDialogOpenSNA::SetInitialPath(AnsiString Value)
{
  mPath = Value;
  mDisplayedPath = "";
  ...
  //
  // Add all supported snapshot files
  //
  // SNA
  if (ButtonSNA->Activated == true)
  {
    if (FindFirst(mPath + SNA_EXT, faAnyFile, sr) == 0)
    {
      do
      {
        ListBoxFiles->Add(sr.Name);
...
AnsiString __fastcall TDialogOpenSNA::GetSelectedFile(void)
{
...
void __fastcall TDialogOpenSNA::SetSelectedFile(AnsiString File)
{
...
void __fastcall TDialogOpenSNA::ClipPath(TDrawingContext* DrawingContextP)
{
  // Get max path extent
...
void __fastcall TDialogOpenSNA::OnExtensionsPressed(void)
{
...
void __fastcall TDialogOpenSNA::OnLoadPressed(void)
{
...
void __fastcall TDialogOpenSNA::OnCancelPressed(void)
{
...
void __fastcall TDialogOpenSNA::OnResize(TDrawingContext* DrawingContextP)
{
...
void __fastcall TDialogOpenSNA::OnDisplay(TDrawingContext* DrawingContextP)
{
...
void __fastcall TDialogOpenSNA::OnDisplayD3D(TDrawingContext* DrawingContextP)
{
#ifdef _USE_DIRECTX
...
void __fastcall TDialogOpenSNA::OnDisplayGL(TDrawingContext* DrawingContextP)
{
#ifdef _USE_OPENGL
...
void __fastcall TDialogOpenSNA::OnDisplayGDI(TDrawingContext* DrawingContextP)
{
  // Draw Dialog background
  RECT BackgroundRect;
