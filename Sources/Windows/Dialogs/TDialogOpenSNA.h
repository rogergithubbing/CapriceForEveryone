...
#ifndef TDialogOpenSNAH
#define TDialogOpenSNAH
...
class TDialogOpenSNA : public TDialogForm
{
private:
  //
  // Members
...
public:
  ...
  // Public API
  //
  __fastcall TDialogOpenSNA(TDrawingContext* DrawingContextP);
  virtual __fastcall ~TDialogOpenSNA();
